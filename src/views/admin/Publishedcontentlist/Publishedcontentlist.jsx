                ...
                <div className="Cardfeed_container">
                  <div className="cardfeed_wrapper publsh_cont_itm">
                    <div className="feedImgTag ">
                      <a className="viewNow" onClick={() => { history.push(`/admin/live-published-content/${curr._id}/Published Content/${contentPage}`) }}>
                        <Swiper
                          spaceBetween={50}
                          slidesPerView={1}
                          centeredSlides
                              ...
                              return (
                                <SwiperSlide key={index}>
                                  {curr?.media_type === "image" ? (
                                    <img
                                      src={curr?.watermark || process.env.REACT_APP_CONTENT + curr?.media}
                                      alt=""
                      ...
                      <div className="feedcontent_wrap">
                        ...
                        <div className="feed_date_time">
                          <small className="feedTime">
                            ...
                            </svg> {`${moment(curr?.published_time_date).format(`hh:mm A`)}  ${moment(curr?.published_time_date).format(`DD MMMM YYYY`)}`}
