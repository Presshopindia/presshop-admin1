...
export default function Uploadedcontentlist() {
  ...
  const GetContents = async (page) => {
    ...
    setLoading(true)
    try {
      await Get(`admin/liveUploadedContent?limit=${6}&offset=${offset}`).then((res) => {
                 ...
                 >
                  ...
                  <div className="cardfeed_wrapper">
                    ...
                    <div className="CardfeedFooter">
                      ...
                      <button className="cardbutton" tabIndex={0} type="button">&pound;{curr?.total_amount_recieved ?? 0}</button>
                    </div>
                  </div>
                    </a>
                </div>
